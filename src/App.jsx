...
function App() {
  return (
    <TaskProvider>
      <div className='min-h-screen bg-[#0F172A] bg-gradient-to-b from-[#0F172A] to-[#1E293B] py-6 sm:py-12 px-3 sm:px-4'>
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='relative text-center mb-8 sm:mb-16'>
            ...
            <div className='mt-3 sm:mt-4 flex justify-center gap-2'>
              <span className='px-2 sm:px-3 py-1 bg-purple-900/30 text-purple-400 text-xs sm:text-sm rounded-full border border-purple-700/50'>
                v5.5
              </span>
              <span className='px-2 sm:px-3 py-1 bg-cyan-900/30 text-cyan-400 text-xs sm:text-sm rounded-full border border-cyan-700/50'>
                Gen Z
              </span>
            </div>
          </div>
