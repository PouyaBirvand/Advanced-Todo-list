...
export const Stats = () => {
  ...
  return (
    <div className='mt-8 bg-gray-900/50 rounded-2xl p-6 backdrop-blur-xl border border-gray-700/50'>
      <h3 className='text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 mb-4'>
        Statistics
      </h3>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
        <div className='bg-gray-800/50 rounded-xl p-4 border border-gray-700/50'>
          ...
          <div className='text-2xl font-bold text-gray-100'>{totalTasks}</div>
        </div>
